  ...
  <div id="theme-modal" class="theme-modal" onclick="if(event.target===this)closeThemeModal()">
    <div class="theme-modal-card">
      ...
      <div class="theme-grid">
        ...
        <button class="theme-option-btn" data-theme-id="poster" onclick="selectTheme('poster')">
        ...
        <button class="theme-option-btn" data-theme-id="brutal" onclick="selectTheme('brutal')">
          <span class="theme-dot" style="background:#FFDE59;border:2px solid #111111;"></span>
          <span>⚡ 新野兽派</span>
        </button>
      </div>
    </div>
